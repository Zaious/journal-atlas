...
| Meta-analysis | 0 | 0 article(s) found (OpenAlex keyword search, 2021-2026, 944 total in window) — automated evidence-only estimate, capped conservatively; does not confirm higher receptiveness, only rules out near-absence |
