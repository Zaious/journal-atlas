...
| Field | Value |
|-------|-------|
| **Abbreviation** | ACM TOHRI |
| **Venue type** | Journal |
| **Publisher** | Association for Computing Machinery (ACM) |
| **ISSN (Print)** | *(N/A — online only)* |
| **ISSN (Online)** | 2573-9522 |
| **Founded** | 2012 (formerly Journal of Human-Robot Interaction; renamed TOHRI 2018) |
| **URL** | https://dl.acm.org/journal/thri |
| **Author / Submission Guidelines** | https://dl.acm.org/journal/thri/author-guidelines |
| **Society / Association** | ACM SIGAI / SIGCHI co-sponsorship |
...
| Metric | Value | Date |
|--------|-------|------|
| **Impact Factor** | 5.1 (2024 JCR) | 2026-05-17 |
| **5-Year IF** | *(see JCR)* | |
| **h-index** | 48 | 2026-09-01 |
...
| Aspect | Detail |
|--------|--------|
| **Article types accepted** | Research articles, Survey papers, Special issues |
...
| **Discourse community signals (editorial board)** | ACM SIGCHI / specialty SIG leadership | https://dl.acm.org/journal/thri |
...
- Empirical HRI studies with users
- Robot design and interaction-paradigm contributions
- Robot ethics, value-sensitive HRI work
- Longer-format HRI research (vs. IEEE HRI conference 6-8pp)

### Not Recommended For

- Pure robotics / control engineering without human-interaction focus
- Conceptual papers without empirical or design contribution

### Rejection Fallback Chain

| Rank | Journal | Why this fallback works |
|------|---------|------------------------|
| 1 | [IEEE HRI Conference](../conferences/hci/ieee-hri.md) | Premier HRI conference; if shorter paper or strong system+study mix |
| 2 | [International Journal of Social Robotics](./international-journal-of-social-robotics.md) | Springer social-robotics peer journal |
| 3 | [ACM CHI](../conferences/hci/acm-chi.md) | Broader HCI venue; if HCI contribution dominates over HRI specifics |
