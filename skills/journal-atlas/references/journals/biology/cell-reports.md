...
| **Author / Submission Guidelines** | https://www.cell.com/cell-reports/authors |
| **Society / Association** | Cell Press family |
| **Editorial Board Location** | US (Cambridge, MA) |
...
| Metric | Value | Date |
|--------|-------|------|
| **Impact Factor** | 7.5 (2024 JCR) | 2026-05-17 |
| **5-Year IF** | *(see JCR)* | |
| **h-index** | 328 | 2026-09-01 |
...
| **Source URL** | https://www.cell.com/policies |
...
| Aspect | Detail |
|--------|--------|
| **Article types accepted** | Articles, Reports, Resources, Theory papers, Reviews, Previews, Snapshots |
| **Word limit** | ~5,500 (Articles); 2,500 (Reports) |
...
| **Discourse community signals (editorial board)** | Biology research community leadership | https://www.cell.com/cell-reports/home |
...
- Broad-scope cell/molecular biology with strong reproducibility
- Papers rejected from Cell that retain significance / mechanism
- Mechanistic studies with cross-discipline appeal
- OA-mandate authors needing Cell Press venue

### Not Recommended For

- Highly specialized subfield work (consider Cell Press specialty journals)
- Incremental confirmatory studies
- Pure methods papers (consider Cell Reports Methods)
