...
| **URL** | https://www.sciencedirect.com/topics/immunology-and-microbiology/immunity |
| **Author Guidelines** | *(fill manually)* |
| **Society / Association** | *(fill manually if applicable)* |
| **Editorial Board Location** | US |
| **OpenAlex ID** | https://openalex.org/S199671312 |
...
| **Articles per year (approx.)** | 1354 *(based on total works / 5 — verify)* |
...
| Topic | Article Count |
|-------|--------------|
| Immune Cell Function and Interaction | 2893 |
| T-cell and B-cell Immunology | 2476 |
| Immunotherapy and Immune Responses | 1487 |
| Immune Response and Inflammation | 768 |
| IL-33, ST2, and ILC Pathways | 471 |
| Immune cells in cancer | 463 |
| interferon and immune responses | 393 |
| CAR-T cell therapy research | 350 |
| Monoclonal and Polyclonal Antibodies Research | 285 |
| Inflammasome and immune disorders | 281 |
