...
| **Author / Submission Guidelines** | https://academic.oup.com/nar/pages/General_Instructions |
...
| Metric | Value | Date |
|--------|-------|------|
| **Impact Factor** | 14.9 (2024 JCR) | 2026-05-17 |
| **5-Year IF** | *(see JCR)* | |
| **h-index** | ~700+ | 2026-05-17 |
...
| Aspect | Detail |
|--------|--------|
| **Model** | Full Open Access (since 2005) |
| **APC (if OA chosen)** | ~$3,650 (2026) |
...
| Aspect | Detail |
|--------|--------|
| **Article types accepted** | Standard Articles, Critical Reviews, Survey & Summary, Methods Online, Database Issue (annual), Web Server Issue (annual) |
| **Word limit** | No strict limit; typical 6,500-10,000 |
| **Word limit negotiability** | Soft (extensions possible with editor approval) |
| **Abstract limit** | 200 words (unstructured) |
...
| **Discourse community signals (editorial board)** | Biology research community leadership | https://academic.oup.com/nar |
...
- Molecular biology / nucleic-acid research with mechanistic insight
- Database papers (annual Database Issue, typically January)
- Web server / tool papers (annual Web Server Issue, typically July)
- Methods papers with broad community uptake potential

### Not Recommended For

- Pure clinical applications without molecular-mechanism contribution
- Database updates without significant new content
- Web servers without unique functionality vs existing tools
