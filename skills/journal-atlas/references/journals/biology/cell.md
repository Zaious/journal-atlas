...
| **2-yr Mean Citedness (OpenAlex IF proxy)** | 40.30 | 2026-09-01 |
| **i10-index** | 22027 | 2026-09-01 |
| **Total Works** | 26900 | 2026-09-01 |
...
| **Articles per year (approx.)** | 5385 *(based on total works / 5 — verify)* |
...
| Aspect | Detail |
|--------|--------|
| **Article types accepted** | Articles, Reviews, Perspectives, Mini-Reviews, Previews, Snapshots |
| **Word limit** | Articles ~50,000 characters with spaces (~7,500 words) |
...
| Topic | Article Count |
|-------|--------------|
| RNA and protein synthesis mechanisms | 2529 |
| RNA Research and Splicing | 2331 |
| Genomics and Chromatin Dynamics | 1966 |
| RNA modifications and cancer | 1520 |
| DNA Repair Mechanisms | 1289 |
| CRISPR and Genetic Engineering | 1219 |
| Microtubule and mitosis dynamics | 1075 |
| Bacterial Genetics and Biotechnology | 1019 |
| Cellular transport and secretion | 942 |
| Immune Cell Function and Interaction | 859 |
...
| 2026-05-16 | Format fields enriched (Word limit / Abstract / Article types) - data adapted from ScienceClaw journals_formatting.md > Cell + cell_press_style.md (MIT) | @cardinal |
